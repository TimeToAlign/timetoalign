...
def profile_all():
    ...
    print(f"Partitura: {len(pt_bundle.notes)} notes, {len(pt_bundle.measures)} measures")
    print(f"Music21:   {len(m21_bundle.notes)} notes (has_rests={m21_bundle.notes.has_rests})")
