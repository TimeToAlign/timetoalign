...
:   Step-by-step notebooks that teach the `timetoalign` library from
    ...
    - [Why TimeToAlign! Matters](tutorials/00_motivation.ipynb)
    - [Timelines, Events, and Maps](tutorials/01a_timelines_events_maps.ipynb)
    - [Children, Regions, and Timestamps](tutorials/01b_children_regions_timestamps.ipynb)
    - [Timeline Groups and Commensurability](tutorials/02_timeline_groups.ipynb)
    - [Alignment Bundles](tutorials/03_alignment_bundles.ipynb)
    - [Flow Control and Grids](tutorials/04_flow_and_grids.ipynb)
