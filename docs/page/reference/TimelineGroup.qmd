...
| Name | Description |
| --- | --- |
| [is_locked](#timetoalign.timelines.TimelineGroup.is_locked) | Whether the group is locked. |
| [n_timelines](#timetoalign.timelines.TimelineGroup.n_timelines) | Number of timelines in the group. |
| [n_timestamps](#timetoalign.timelines.TimelineGroup.n_timestamps) | Number of boundary timestamps. |
| [timeline_ids](#timetoalign.timelines.TimelineGroup.timeline_ids) | IDs of all member timelines. |
| [timestamps](#timetoalign.timelines.TimelineGroup.timestamps) | All boundary timestamps as view objects. |
...
| [unfold](#timetoalign.timelines.TimelineGroup.unfold) | Unfold ALL timelines in this group via a single flow. |
...
### unfold { #timetoalign.timelines.TimelineGroup.unfold }

```python
timelines.TimelineGroup.unfold(
    flow,
    flow_controller,
