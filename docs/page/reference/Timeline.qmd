...
| [create_regions_by_grouping](#timetoalign.Timeline.create_regions_by_grouping) | Create regions by grouping *adjacent* events on a column value. |
...
| [create_segment_line_by_grouping](#timetoalign.Timeline.create_segment_line_by_grouping) | Create a SegmentLine by grouping adjacent events on a column value. |
...
| [get_timestamps](#timetoalign.Timeline.get_timestamps) | Generate timestamps as a pandas DataFrame with units in column names. |
...
| [to_dataframe](#timetoalign.Timeline.to_dataframe) | Generate timestamps as a pandas DataFrame with formatted column names. |
