...
| Name | Description |
| --- | --- |
| [is_invertible](#timetoalign.ConstantMap.is_invertible) | ConstantMap is not invertible (many-to-one mapping). |
| [value](#timetoalign.ConstantMap.value) | The constant value returned for every input. |
