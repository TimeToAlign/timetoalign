...
```python
PiecewiseMap(breaks, maps, source_unit=None, target_unit=None, uid=None)
```
...
| Name | Description |
| --- | --- |
| [breaks](#timetoalign.PiecewiseMap.breaks) | The interval boundaries. |
| [maps](#timetoalign.PiecewiseMap.maps) | The maps for each interval. |
