...
| [schema](#timetoalign.EventData.schema) | Get the PyArrow schema for this EventData class. |
...
| [to_timeline](#timetoalign.EventData.to_timeline) | Deprecated alias for create_timeline(). |
...
### schema { #timetoalign.EventData.schema }

```python
EventData.schema(unit)
```
...
### to_timeline { #timetoalign.EventData.to_timeline }

```python
EventData.to_timeline(uid=None, filters=None)
```
