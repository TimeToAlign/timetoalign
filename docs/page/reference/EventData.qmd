...
| [from_fields](#timetoalign.EventData.from_fields) | Legacy from_arrays using row-based coordinate_to_struct. |
...
### from_fields { #timetoalign.EventData.from_fields }

```python
EventData.from_fields(fields, unit, number_type=NumberType.float)
```
