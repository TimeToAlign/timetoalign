...
|------------|----------------------|--------------------------------------------------------------------------------------------------------------|
| kind       | [str](`str`)         | Short machine-readable violation tag (e.g. ``"volta_follows_volta"``).                                       |
| message    | [str](`str`)         | Human-readable explanation, including a remediation hint.                                                    |
| section_id | [str](`str`) \| None | The offending source section's id, if the violation is attributable to a single section. ``None`` otherwise. |
| mc         | [int](`int`) \| None | The measure count most relevant to the violation, if any.                                                    |
