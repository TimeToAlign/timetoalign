# ClaimFilter { #timetoalign.ClaimFilter }
...
| Name | Description |
| --- | --- |
| [from_kwargs](#timetoalign.ClaimFilter.from_kwargs) | Create a ClaimFilter from keyword arguments. |
| [matches_claim](#timetoalign.ClaimFilter.matches_claim) | Test whether a MatchClaim passes all filter criteria. |
| [matches_timeline](#timetoalign.ClaimFilter.matches_timeline) | Test whether a single timeline ID passes the filter criteria. |

### from_kwargs { #timetoalign.ClaimFilter.from_kwargs }
...
### matches_claim { #timetoalign.ClaimFilter.matches_claim }
...
### matches_timeline { #timetoalign.ClaimFilter.matches_timeline }
