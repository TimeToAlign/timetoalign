...
| coordinate  | [float](`float`) | The exact coordinate value on that timeline.  | _required_ |
...
| Name   | Type                       | Description                                                                                                 |
|--------|----------------------------|-------------------------------------------------------------------------------------------------------------|
|        | [ValueError](`ValueError`) | If any claim is non-synchronous (NOMATCH), lacks a start anchor, or is an interval (carries an end anchor). |
...
| Name   | Type                                                                      | Description                                        |
|--------|---------------------------------------------------------------------------|----------------------------------------------------|
|        | [list](`list`)\[[MatchClaim](`timetoalign.alignment.claims.MatchClaim`)\] | A list of synchronous instant claims, one per row. |
