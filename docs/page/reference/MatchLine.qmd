# MatchLine { #timetoalign.MatchLine }
...
| Name | Description |
| --- | --- |
| [n_stamps](#timetoalign.MatchLine.n_stamps) | Number of stamps in this MatchLine. |
| [source_coordinates](#timetoalign.MatchLine.source_coordinates) | Sorted list of coordinates on the source timeline. |

## Methods

| Name | Description |
| --- | --- |
| [from_claims](#timetoalign.MatchLine.from_claims) | Build a MatchLine from claims via a MatchGraph. |
| [from_dict](#timetoalign.MatchLine.from_dict) | Deserialize from dictionary. |
| [from_graphs](#timetoalign.MatchLine.from_graphs) | Build a MatchLine from multiple MatchGraphs. |
| [get_coordinate_pairs](#timetoalign.MatchLine.get_coordinate_pairs) | Extract (source_coord, target_coord) pairs for a target timeline. |
| [save_as](#timetoalign.MatchLine.save_as) | Export this MatchLine to a file. |
| [target_timeline_ids](#timetoalign.MatchLine.target_timeline_ids) | All target timelines appearing in at least 2 stamps. |
| [to_dict](#timetoalign.MatchLine.to_dict) | Serialize to dictionary for storage. |

### from_claims { #timetoalign.MatchLine.from_claims }
...
### from_dict { #timetoalign.MatchLine.from_dict }
...
### from_graphs { #timetoalign.MatchLine.from_graphs }
...
### get_coordinate_pairs { #timetoalign.MatchLine.get_coordinate_pairs }
...
### save_as { #timetoalign.MatchLine.save_as }
...
### target_timeline_ids { #timetoalign.MatchLine.target_timeline_ids }
...
### to_dict { #timetoalign.MatchLine.to_dict }
