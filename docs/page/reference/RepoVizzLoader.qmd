...
| Name | Description |
| --- | --- |
| [catalogue](#timetoalign.RepoVizzLoader.catalogue) | The full catalogue of entries (XML mode only). |
| [duration_seconds](#timetoalign.RepoVizzLoader.duration_seconds) | Duration in seconds (legacy CSV mode only). |
| [frame_rate](#timetoalign.RepoVizzLoader.frame_rate) | Sampling rate in Hz (legacy CSV mode only). |
| [groups](#timetoalign.RepoVizzLoader.groups) | List of all group names present (XML mode only). |
| [info](#timetoalign.RepoVizzLoader.info) | Return parsed RepoVizz metadata (legacy CSV mode only). |
| [is_xml_mode](#timetoalign.RepoVizzLoader.is_xml_mode) | True if loader is in XML manifest mode, False for legacy CSV. |
| [n_samples](#timetoalign.RepoVizzLoader.n_samples) | Number of data samples (legacy CSV mode only). |
| [store](#timetoalign.RepoVizzLoader.store) | The ``RepovizzDictStore`` containing catalogue and cached data. |
| [timeline_ids](#timetoalign.RepoVizzLoader.timeline_ids) | Identifiers for all loadable timelines (XML mode only). |
| [timeline_specs](#timetoalign.RepoVizzLoader.timeline_specs) | Metadata dicts for each loadable timeline (XML mode only). |

## Methods

| Name | Description |
| --- | --- |
| [clear](#timetoalign.RepoVizzLoader.clear) | Clear all loaded data. |
| [create_group](#timetoalign.RepoVizzLoader.create_group) | Create a TimelineGroup containing timelines. |
| [create_timeline](#timetoalign.RepoVizzLoader.create_timeline) | Create a DiscretePhysicalTimeline from a catalogue entry. |
| [create_timelines](#timetoalign.RepoVizzLoader.create_timelines) | Create multiple timelines. |
| [find_audio](#timetoalign.RepoVizzLoader.find_audio) | Find an audio entry by source name. |
| [find_audio_descriptor](#timetoalign.RepoVizzLoader.find_audio_descriptor) | Find an audio descriptor entry (Essentia features). |
| [find_descriptor](#timetoalign.RepoVizzLoader.find_descriptor) | Find a descriptor entry by name. |
| [find_signal](#timetoalign.RepoVizzLoader.find_signal) | Find a signal entry by name pattern. |
| [from_file](#timetoalign.RepoVizzLoader.from_file) | Load files and return the loader (convenience constructor). |
| [get_entry](#timetoalign.RepoVizzLoader.get_entry) | Get a catalogue entry by ID. |
| [get_sample_rate_for_descriptor_type](#timetoalign.RepoVizzLoader.get_sample_rate_for_descriptor_type) | Get the sample rate for a descriptor type. |
| [load](#timetoalign.RepoVizzLoader.load) | Load one or more source files. |

### clear { #timetoalign.RepoVizzLoader.clear }
...
### create_group { #timetoalign.RepoVizzLoader.create_group }
...
### create_timelines { #timetoalign.RepoVizzLoader.create_timelines }
...
### find_audio { #timetoalign.RepoVizzLoader.find_audio }
...
### find_audio_descriptor { #timetoalign.RepoVizzLoader.find_audio_descriptor }
...
### find_descriptor { #timetoalign.RepoVizzLoader.find_descriptor }
...
### find_signal { #timetoalign.RepoVizzLoader.find_signal }
...
### get_entry { #timetoalign.RepoVizzLoader.get_entry }
...
### get_sample_rate_for_descriptor_type { #timetoalign.RepoVizzLoader.get_sample_rate_for_descriptor_type }
...
### load { #timetoalign.RepoVizzLoader.load }
