...
| [to_timeline](#timetoalign.RepoVizzLoader.to_timeline) | Create a DiscretePhysicalTimeline from the loaded sensor data. |
...
### to_timeline { #timetoalign.RepoVizzLoader.to_timeline }

```python
RepoVizzLoader.to_timeline(uid=None, name=None, attach_cmap=True)
```
