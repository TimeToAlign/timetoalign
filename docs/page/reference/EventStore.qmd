...
| [to_default_timeline](#timetoalign.EventStore.to_default_timeline) | Create a canonical timeline from this store's data. |
| [to_timeline](#timetoalign.EventStore.to_timeline) | Deprecated alias for create_timeline(). |
...
### to_default_timeline { #timetoalign.EventStore.to_default_timeline }

```python
EventStore.to_default_timeline(uid=None)
```
...
### to_timeline { #timetoalign.EventStore.to_timeline }
