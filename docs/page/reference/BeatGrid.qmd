...
| Name | Description |
| --- | --- |
| [beat_unit](#timetoalign.timelines.BeatGrid.beat_unit) | Note value of one beat (fraction of whole note). |
| [beats_per_measure](#timetoalign.timelines.BeatGrid.beats_per_measure) | Number of beats per measure. |
| [meter_map](#timetoalign.timelines.BeatGrid.meter_map) | The underlying MetricMap (for advanced access). |
| [n_beats](#timetoalign.timelines.BeatGrid.n_beats) | Total number of beats in this grid. |
| [n_measures](#timetoalign.timelines.BeatGrid.n_measures) | Number of complete measures in this grid. |
| [quarters_per_beat](#timetoalign.timelines.BeatGrid.quarters_per_beat) | Quarter notes per beat. |
| [quarters_per_measure](#timetoalign.timelines.BeatGrid.quarters_per_measure) | Quarter notes per measure. |
| [start_measure](#timetoalign.timelines.BeatGrid.start_measure) | MC (measure count) of the first measure. |
| [start_mn](#timetoalign.timelines.BeatGrid.start_mn) | MN (measure number label) of the first measure. |
| [tempo_bpm](#timetoalign.timelines.BeatGrid.tempo_bpm) | Tempo in BPM, if created via from_tempo(). |
