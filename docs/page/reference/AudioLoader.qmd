...
| [create_timeline](#timetoalign.AudioLoader.create_timeline) | Create a DiscretePhysicalTimeline from the loaded audio. |
...
### create_timeline { #timetoalign.AudioLoader.create_timeline }

```python
AudioLoader.create_timeline(uid=None, name=None, attach_cmap=True)
```
