...
| Name | Description |
| --- | --- |
| [is_invertible](#timetoalign.WarpMap.is_invertible) | Whether the inverse mapping is defined. |
| [n_anchors](#timetoalign.WarpMap.n_anchors) | Number of anchor points used for interpolation. |
| [source_coords](#timetoalign.WarpMap.source_coords) | The source coordinate anchor points (read-only). |
| [target_coords](#timetoalign.WarpMap.target_coords) | The target coordinate anchor points (read-only). |

## Methods

| Name | Description |
| --- | --- |
| [forward](#timetoalign.WarpMap.forward) | Convert source coordinate(s) to target coordinate(s). |
| [from_coordinate_pairs](#timetoalign.WarpMap.from_coordinate_pairs) | Build a WarpMap from explicit coordinate arrays. |
| [from_dict](#timetoalign.WarpMap.from_dict) | Deserialize from dictionary. |
| [from_match_line](#timetoalign.WarpMap.from_match_line) | Build a WarpMap from a MatchLine's coordinate pairs. |
| [inverse](#timetoalign.WarpMap.inverse) | Convert target coordinate(s) to source coordinate(s). |
| [materialise](#timetoalign.WarpMap.materialise) | Produce a new Timeline with all contents warped to target coordinates. |
| [to_dict](#timetoalign.WarpMap.to_dict) | Serialize to dictionary. |

### forward { #timetoalign.WarpMap.forward }
...
### from_coordinate_pairs { #timetoalign.WarpMap.from_coordinate_pairs }
...
### from_dict { #timetoalign.WarpMap.from_dict }
...
### from_match_line { #timetoalign.WarpMap.from_match_line }
...
### inverse { #timetoalign.WarpMap.inverse }
...
### materialise { #timetoalign.WarpMap.materialise }
...
### to_dict { #timetoalign.WarpMap.to_dict }
