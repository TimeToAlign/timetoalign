...
| Name | Description |
| --- | --- |
| [claims](#timetoalign.alignment.MatchGraph.claims) | List of all MatchClaims in this graph (synchronous and non-synchronous). |
| [n_claims](#timetoalign.alignment.MatchGraph.n_claims) | Number of claims in this graph. |
| [n_components](#timetoalign.alignment.MatchGraph.n_components) | Number of connected components in the graph. |
| [n_edges](#timetoalign.alignment.MatchGraph.n_edges) | Number of edges in the graph. |
| [n_nodes](#timetoalign.alignment.MatchGraph.n_nodes) | Number of nodes in the graph. |
| [non_synchronous_claims](#timetoalign.alignment.MatchGraph.non_synchronous_claims) | List of non-synchronous MatchClaims (NOMATCH, conceptual). |
| [synchronous_claims](#timetoalign.alignment.MatchGraph.synchronous_claims) | List of only synchronous MatchClaims (those with anchors/edges). |
