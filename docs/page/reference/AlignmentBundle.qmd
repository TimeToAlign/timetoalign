...
| [add_match_claim_field](#timetoalign.AlignmentBundle.add_match_claim_field) | Add a columnar ``MatchClaimField`` of cross-group claims. |
...
### add_match_claim_field { #timetoalign.AlignmentBundle.add_match_claim_field }

```python
AlignmentBundle.add_match_claim_field(claim_field)
```
...
```python
AlignmentBundle.get_timestamp_at(
    coordinate,
    timeline_id=None,
    *,
    format='prefix',
