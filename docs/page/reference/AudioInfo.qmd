# AudioInfo { #timetoalign.AudioInfo }
...
| Name | Description |
| --- | --- |
| [is_mono](#timetoalign.AudioInfo.is_mono) | Whether the audio is mono (single channel). |
| [is_stereo](#timetoalign.AudioInfo.is_stereo) | Whether the audio is stereo (two channels). |
| [length_in_samples](#timetoalign.AudioInfo.length_in_samples) | Alias for n_samples, matching timeline terminology. |
