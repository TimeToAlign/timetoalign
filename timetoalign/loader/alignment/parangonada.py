            ...
            [
                {
                    ...
                    "event_type": "Note",
                    # Number-only source: the most-expressive faithful pitch
                    # type is EnharmonicPitch, carried as its {midi_number}
                    # struct so the timeline affords the EP semantic field.
